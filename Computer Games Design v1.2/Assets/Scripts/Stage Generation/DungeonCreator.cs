...
public class DungeonCreator : MonoBehaviour //WALLS BEGONE... For now until I get the floor collisions working.
{
    ...
    private void CreateMesh(Vector2 bottomLeftCorner, Vector2 topRightCorner)
    {
        ...
        //dungeonFloor.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.FreezeAll;
